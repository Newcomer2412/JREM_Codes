...
{
    /// <summary>
    /// StartLoadingUI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class StartLoadingUI : Window
    {
        public StartLoadingUI()
        {
            InitializeComponent();
            TbSystemName.Text = Define.SYSTEM_NAME;
        }
    }
    ...
    public class GifImage : Image
    {
        ...
        {
            Dispatcher.BeginInvoke(DispatcherPriority.Send, new Action(FrameUpdatedCallback));
        }
