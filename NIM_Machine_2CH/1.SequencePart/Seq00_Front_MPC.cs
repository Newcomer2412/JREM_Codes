    ...
    public class Seq00_Front_MPC : ISequence, ISeqNo
    {
                ...
                case 0:
                    {
                            ...
                            MPC1_NeedleMount != null && MPC1_Flip != null && MPC1_Dispensing != null && MPC1_FarRight != null)
                        {
                            ...
                            bPitchMoveMapData = (MPC1_Buffer1.GetStatus(eStatus.HOLDER) || MPC1_Buffer1.GetStatus(eStatus.EMPTY)) &&
                                                               ((!MPC1_PipeMount.GetStatus(eStatus.FIRST_HOLE) && !MPC1_PipeMount.GetStatus(eStatus.EMPTY)) || MPC1_PipeMount.GetAllStatus(eStatus.EMPTY, true)) &&
                                                               (MPC1_Buffer2.GetStatus(eStatus.HOLDER) || MPC1_Buffer2.GetStatus(eStatus.EMPTY)) &&
                                                               ((!MPC1_NeedleMount.GetStatus(eStatus.HOLDER) && !MPC1_NeedleMount.GetStatus(eStatus.EMPTY)) || MPC1_NeedleMount.GetAllStatus(eStatus.EMPTY, true)) &&
                            ...
                            bool bFlipMapData = MPC1_Flip.GetStatus(eStatus.SECOND_MOUNT) || MPC1_Flip.GetStatus(eStatus.SKIPPED);
        ...
        public bool MPCMovePitch()
        {
            ...
            switch (iSubStep)
            {
                ...
                case 32:    // MPC 이동 전 벨트 Pitch 확인 (정확한 Pitch 이동이 되려면 벨트 안쪽면의 이빨을 감지해야 한다)
                    {
