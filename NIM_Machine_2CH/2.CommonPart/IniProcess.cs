...
namespace MachineControlBase
{
    ...
    public class CIniFile : IEnumerable<KeyValuePair<string, IniSection>>, IDictionary<string, IniSection>
    {
        ...
        public CIniFile(IEqualityComparer<string> stringComparer)
        {
    ...
    public class IniSection : IEnumerable<KeyValuePair<string, IniValue>>, IDictionary<string, IniValue>
    {
        ...
        public IniSection(Dictionary<string, IniValue> values)
            : this(values, CIniFile.DefaultComparer)
        {
        }
