...
namespace EMotionUniBase
{
    ...
    public class UniDevice
    {
        ...
        public enum eUniApiReturnCode
        {
            ...
            RequestTimeout = ConnectionBase + 10,

            CommunicationBase = 100,
            InvalidCommand = CommunicationBase + 0,
            ...
            NotConfiguration = OperationBase + 10,
            SameSequenceNumber = OperationBase + 18,
            NotDriveReady = OperationBase + 20,
            NotServoOn = OperationBase + 21,
            AlarmOccurred = OperationBase + 30,
            AlreadyMoving = OperationBase + 31,
            InvalidTargetPosition = OperationBase + 50,
            RadiusTooSmall = OperationBase + 51,
            FailedErase = OperationBase + 73,
            FailedWrite = OperationBase + 74,
            FailedRead = OperationBase + 75,
        ...
        /// </summary>
        public enum eUniAxisInputNumber
        {
        ...
        /// </summary>
        private enum eUniAxisOutputNumber
        {
            Output0 = 0,
            Output1 = 1,
        }
        ...
        /// </summary>
        private enum eUniAxisHomingSensor
        {
        ...
        /*** The max count of touch probe ***/
        public readonly int UNI_MAX_TOUCH_PROBE_COUNT = 2;
        ...
        public static extern int eUniConnect(int netId, int port);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniConnectEx(int ip1, int ip2, int ip3, int ip4, int port);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniConnectToTcp(int netId, int port);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniConnectToTcpEx(int ip1, int ip2, int ip3, int ip4, int port);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniDisconnect(int netId);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniReconnect(int netId);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniIsConnected(int netId, [MarshalAs(UnmanagedType.I1)] out bool connected);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniCheckConnection(int netId);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetCommunicationConfig(int netId, int time, int retryCount);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetCommunicationConfig(int netId, out int time, out int retryCount);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetSystemErrorCode(int netId, out int error);

        /*** Log ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetLogInfo(int netId, [MarshalAs(UnmanagedType.I1)] out bool loggable);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniEnableLog(int netId, [MarshalAs(UnmanagedType.I1)] bool enable, StringBuilder logPath);

        /*** Version ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetOsVersion(int netId, out int version);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetApiVersion();

        /*** Info ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetDeviceType(int netId, out int type);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetAxisCount(int netId, out int count);

        /*** Parameter ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniWriteParameter(int netId, int paramNo, int axisNo, int dataType, int data, float fdata);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniReadParameter(int netId, int paramNo, int axisNo, int dataType, out int data, IntPtr fdata);

        /*** Status ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetErrorCode(int netId, int axisNo, out int error);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetDriveStatus(int netId, int axisNo, out int status, IntPtr fstatus);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetDriveAlarm(int netId, int axisNo, out int alarm);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMotionStatus(int netId, int axisNo, out int status);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMotionAlarm(int netId, int axisNo, out int alarm);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetConfiguration(int netId, int axisNo, out int configuration);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMotionDone(int netId, int axisNo, out int done);

        /*** RPM, Voltage and Current ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetCommandRpm(int netId, int axisNo, IntPtr rpm);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMotorRpm(int netId, int axisNo, IntPtr rpm);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMotorCurrent(int netId, int axisNo, IntPtr current);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetDcLinkVoltage(int netId, int axisNo, IntPtr voltage);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetDeviceTemperature(int netId, int axisNo, IntPtr temperature);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetCpuTemperature(int netId, int axisNo, IntPtr temperature);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetAllPulse(int netId, out int commandPulse, out int actualPulse, out int errorPulse);

        /*** Position ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetCommandPosition(int netId, int axisNo, int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetCommandPosition(int netId, int axisNo, out int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetActualPosition(int netId, int axisNo, int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetActualPosition(int netId, int axisNo, out int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetHomePosition(int netId, int axisNo, int offsetPosition);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetAllPosition(int netId, out int commandPosition, out int actualPosition);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetAllPositionEx(int netId, out int commandPosition, out int actualPosition, out int errorPosition);

        /*** Servo Enable ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetServoOn(int netId, int axisNo, int enable);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetServoOn(int netId, int axisNo, out int enable);

        /*** Operation ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniReset(int netId, int axisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSlowStop(int netId, int axisNo, int decelTime);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniEmergencyStop(int netId, int axisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniOverrideVelocity(int netId, int axisNo, int rate);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetSyncAxis(int netId, int axisNo, int enable, int syncAxisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetSyncAxis(int netId, int axisNo, out int enable, out int syncAxisNo);

        /*** Motion ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMove(int netId, int axisNo, int moveType, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                int target, int point, int edge, int preCheck, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveTrapezoidal(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int position, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveTrapezoidalIo(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int position, int point, int edge, int preCheck, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveSCurve(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int position, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveSCurveIo(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int position, int point, int edge, int preCheck, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveVelocity(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int direction);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveVelocityIo(int netId, int axisNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int direction, int point, int edge, int preCheck);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveLine(int netId, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int axisA_Position, int axisB_Position, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveArcRadius(int netId, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int axis0_position, int axis1_position, int cwCcw, int radius, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveArcAngle(int netId, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                            int centerX, int centerY, int angle, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniMoveCircleAngle(int netId, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                                int cwCcw, int centerX, int centerY, int rotateCount, int angle, int mode = (int)eUniMotionMode.Absolute);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetSyncVelocityFromCircleAngle(int netId, int centerX, int centerY, int rotateCount, int angle, int velocity,
                                                                            int position, out int syncVelocity);

        /*** Homing ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniAddHomingStep(int netId, int axisNo, int stepNo, int velocity, int accel, int decel, int jerkAcc, int jerkDec,
                                                    int direction, int point, int edge, int preCheck, int delay);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniRemoveHomingStep(int netId, int axisNo, int stepNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniRemoveAllHomingStep(int netId, int axisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetHomingStep(int netId, int axisNo, int stepNo, out int velocity, out int accel, out int decel, out int jerkAcc, out int jerkDec,
                                                            out int direction, out int point, out int edge, out int preCheck, out int delay);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetHomingStepCount(int netId, int axisNo, out int count);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetHomingShift(int netId, int axisNo, int use, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetHomingShift(int netId, int axisNo, out int use, out int velocity, out int accel, out int decel, out int jerkAcc, out int jerkDec, out int position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartHoming(int netId, int axisNo, int homePosition);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartHomingMethod(int netId, int axisNo, int methodNo, int switchVelocity, int switchAccel, int switchDecel, int homingVelocity, int homingAccel, int homingDecel, int offsetPosition, int useMoveOffset);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartHomingMethodEx(int netId, int axisNo, int methodNo, int switchVelocity, int switchAccel, int switchDecel, int homingVelocity, int homingAccel, int homingDecel, int offsetPosition, int useMoveOffset, int useDeltaPosition);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStopHoming(int netId, int axisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniIsHoming(int netId, int axisNo, out int isHoming, out int isStep, out int isOffset);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetHomingResult(int netId, int axisNo, out int stepNo, out int rate, out int statusCode);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetHomingResultEx(int netId, int axisNo, out int stepNo, out int rate, out int statusCode, out int status);

        /*** In-position ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetInpositionPulseRange(int netId, int axisNo, int pulse);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetInpositionPulseRange(int netId, int axisNo, out int pulse);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetInpositionDuration(int netId, int axisNo, int time);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetInpositionDuration(int netId, int axisNo, out int time);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetInpositionTimeout(int netId, int axisNo, int time);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetInpositionTimeout(int netId, int axisNo, out int time);

        /*** Software Position Limit ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetSoftwarePositionLimit(int netId, int axisNo, int negativePosition, int positivePosition);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetSoftwarePositionLimit(int netId, int axisNo, out int negativePosition, out int positivePosition);

        /*** Touch Probe ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartTouchProbe(int netId, int axisNo, int touchProbeNo, int input, int edge);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStopTouchProbe(int netId, int axisNo, int touchProbeNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetTouchProbePosition(int netId, int axisNo, int touchProbeNo, out int position, out int firstPosition);

        /*** I/O ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetOutput(int netId, int axisNo, int outputNo, int onOff);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetIo(int netId, int axisNo, out int input, out int output);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetSignalStatus(int netId, int axisNo, out int limitN, out int limitP, out int home, out int alarm, out int ready, out int on);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetStoIo(int netId, int axisNo, out int input, out int output, out int active);

        /*** Trigger ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetTriggerOn(int netId, int axisNo, int enable);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetTriggerOn(int netId, int axisNo, out int enable);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetTriggerCount(int netId, int axisNo, out int count);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniResetTrigger(int netId, int axisNo);

        /*** Loopback ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetLoopback(int netId, int axisNo, int enable);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetLoopback(int netId, int axisNo, out int enable);

        /*** Monitoring ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartMonitoring(int netId, int axisNo, int interval, int type = (int)eUniMonitoringSource.Position);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStopMonitoring(int netId, int axisNo);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMonitoringInfo(int netId, out int axisNo, out int command, out int interval, out int dataIndex);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetMonitoringData(int netId, int dataIndex, int dataCount, out int commandData, out int actualData, out int status);

        /*** Repeat ***/

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniSetRepeatPosition(int netId, int axis, int index, int enable, int absolute, int inPosition, int profile, int position, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int delay);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetRepeatPosition(int netId, int axis, int index, out int enable, out int absolute, out int inPosition, out int profile, out int position, out int velocity, out int accel, out int decel, out int jerkAcc, out int jerkDec, out int delay);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStartRepeat(int netId, int axis, int count);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniStopRepeat(int netId, int axis);

        [DllImport("EMotionUniDevice.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int eUniGetRepeatStatus(int netId, int axis, out int repeating, out int index);

        #endregion API Import
        ...
        /// <param name="ip4">	    : Network ID(IP address 4)</param>
        /// <param name="port">		: Network Port</param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        /// @ eUniApiReturnCode.Success				: Operation Success
        ...
        /// @ eUniApiReturnCode.FailedCommunication : Failed to try to communicate to device
        /// </returns>
        public virtual int Connect(int ip1, int ip2, int ip3, int ip4, int port)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniConnectEx(ip1, ip2, ip3, ip4, port);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to connect device" +
                            "(Network: " + ip1 + "." + ip2 + "." + ip3 + "." + ip4 +
                            ", Port number: " + port + "). " +
                            "error : " + returnCode,
                            "UniDevice.Connect");
                }
        ...
        /// <summary>
        /// Connect to device using ethernet(TCP)
        /// </summary>
        /// <param name="netId">	: Network ID(IP address 4)</param>
        /// <param name="port">		: Network Port</param>
        /// <returns>
        ...
        /// @ eUniApiReturnCode.FailedCommunication : Failed to try to communicate to device
        /// </returns>
        public virtual int ConnectToTcp(int netId, int port)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniConnectToTcp(netId, port);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to connect device" +
                            "(Network ID: " + netId.ToString() +
                            ", Port number: " + port.ToString() + "). " +
                            "error : " + returnCode,
                            "UniDevice.ConnectToTcp");
                }
                this.NetID = netId;
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.ConnectToTcp");
                returnCode = -1;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This API is extension function 'ConnectToTcp' included arguments about IP address
        /// </remarks>
        /// <param name="ip1">		: IPv4 address 1</param>
        /// <param name="ip2">		: IPv4 address 2</param>
        /// <param name="ip3">		: IPv4 address 3</param>
        ...
        /// @ eUniApiReturnCode.FailedCommunication : Failed to try to communicate to device
        /// </returns>
        public virtual int ConnectToTcp(int ip1, int ip2, int ip3, int ip4, int port)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniConnectToTcpEx(ip1, ip2, ip3, ip4, port);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to connect device" +
                            "(Network: " + ip1 + "." + ip2 + "." + ip3 + "." + ip4 +
        ...
        /// <param name="useMoveOffset">	: Determine whether moving to offset(position) is enable or disable. If no use moving offset, the value to set home position</param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        /// @ eUniApiReturnCode.Success						: Operation Success
        /// @ eUniApiReturnCode.NotConnected				: Not connected to device
        ...
        /// @ eUniApiReturnCode.AlreadyOperation			: The homing operation is already started
        /// @ eUniApiReturnCode.FailedOperation				: Failed to start the homing operation
        /// @ eUniApiReturnCode.NotConfiguration			: No set limit switch setting(parameter)
        ...
        public virtual int StartHomingMethod(int axisNo, int methodNo, int switchVelocity, int switchAccel, int switchDecel, int homingVelocity, int homingAccel, int homingDecel, int offsetPosition, bool useMoveOffset)
        {
            ...
            try
            {
                returnCode = eUniStartHomingMethod(this.NetID, axisNo, methodNo, switchVelocity, switchAccel, switchDecel, homingVelocity, homingAccel, homingDecel, offsetPosition, useMoveOffset ? 1 : 0);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
        ...
        /// <summary>
        /// Start homing operation using extension homing method
        /// </summary>
        /// <remarks>
        /// The homing method is implemented as defined in CIA402 drive profile - homing mode.
        /// See the CIA402 drive profile related manual or the UNI drive manual.
        ...
        /// <param name="offsetPosition">	: The offset to set or to move position after homing</param>
        /// <param name="useMoveOffset">	: Determine whether moving to offset(position) is enable or disable. If no use moving offset, the value to set home position</param>
        /// <param name="useDeltaPosition">	: Determine whether writing delta position(between stop position and motor index position) is enable or disable. If no use argument, write 0 to position after homing/param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        /// @ eUniApiReturnCode.Success						: Operation Success
        /// @ eUniApiReturnCode.NotConnected				: Not connected to device
        ...
        /// @ eUniApiReturnCode.InvalidAddress				: The homing method number is invalid
        /// </returns>
        public virtual int StartHomingMethodEx(int axisNo, int methodNo, int switchVelocity, int switchAccel, int switchDecel, int homingVelocity, int homingAccel, int homingDecel, int offsetPosition, bool useMoveOffset, bool useDeltaPosition)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniStartHomingMethodEx(this.NetID, axisNo, methodNo, switchVelocity, switchAccel, switchDecel, homingVelocity, homingAccel, homingDecel, offsetPosition, useMoveOffset ? 1 : 0, useDeltaPosition ? 1 : 0);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to start homing method to device" +
                            "(Network ID: " + this.NetID.ToString() +
        ...
        /// <summary>
        /// Start touch probe(latch position)
        /// </summary>
        /// <remarks>
        /// This function is started touch probe which does latch position when to detect strobe(input) and motor index(z-phase)
        /// </remarks>
        /// <param name="axisNo">	: Axis number</param>
        /// <param name="touchProbeNo">	: Touch probe number(0, 1)</param>
        /// <param name="input">	:  Signal(Input) type.
        ///	@ 1 : Input 1
        ///	@ 3 : Input 3
        ///	@ 255 : Motor index(Z phase)
        ///	</param>
        /// <param name="edge">		: Signal(input) edge type when to latch
        /// 0: Rising edge
        /// 1: Falling edge
        /// </param>
        /// <returns>
        ...
        /// @ eUniApiReturnCode.InvalidSequenceNumber		: The communication message to be received from device is invalid sequence
        /// @ eUniApiReturnCode.InvalidCommunicationFormat	: The communication message to be received from device is invalid command format
        /// @ eUniApiReturnCode.InvalidAddress				: The number of touch probe is invalid. the touch probe only exists 0, 1
        /// </returns>
        public virtual int StartTouchProbe(int axisNo, int touchProbeNo, int input, int edge)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniStartTouchProbe(this.NetID, axisNo, touchProbeNo, input, edge);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to start touch probe to device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axisNo.ToString() + "). " +
                            "error : " + returnCode,
                            "UniDevice.StartTouchProbe");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.StartTouchProbe");
                returnCode = -1;
            }
        ...
        /// <summary>
        /// Stop touch probe(latch position)
        /// </summary>
        /// <param name="axisNo">	: Axis number</param>
        /// <param name="touchProbeNo">	: Touch probe number(0, 1)</param>
        /// <returns>
        ...
        /// @ eUniApiReturnCode.InvalidAddress				: The number of touch probe is invalid. the touch probe only exists 0, 1
        /// </returns>
        public virtual int StopTouchProbe(int axisNo, int touchProbeNo)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniStopTouchProbe(this.NetID, axisNo, touchProbeNo);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to stop touch probe to device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axisNo.ToString() + "). " +
                            "error : " + returnCode,
                            "UniDevice.StopTouchProbe");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.StopTouchProbe");
                returnCode = -1;
            }
        ...
        /// @ eUniApiReturnCode.ArgumentNullPointer			: The argument is null
        /// </returns>
        public virtual int GetTouchProbePosition(int axisNo, int touchProbeNo, int[] position, int[] firstPosition)
        {
            int returnCode = (int)eUniApiReturnCode.Success;
            ...
            try
            {
                returnCode = eUniGetTouchProbePosition(this.NetID, axisNo, touchProbeNo, out position[0], out firstPosition[0]);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to get touch probe(latched) position from device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axisNo.ToString() + "). " +
                            "error : " + returnCode,
                            "UniDevice.GetTouchProbePosition");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.GetTouchProbePosition");
                returnCode = -1;
            }
        ...
        /// </param>
        /// <param name="active">
        /// * Index 0 : Active 0 On / Off(On : 1, Off : 0)
        /// * Index 1 : Active 1 On / Off(On : 1, Off : 0)
        /// * ...
        /// </param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        ...
        /// @ eUniApiReturnCode.ArgumentNullPointer			: The argument is null
        /// </returns>
        public virtual int GetStoIo(int axisNo, bool[] input, bool[] output, bool[] active)
        {
            int returnCode = (int)eUniApiReturnCode.Success;
            int count = 8;
            ...
            int[] inputTemp = new int[count];
            int[] outputTemp = new int[count];
            int[] activeTemp = new int[count];

            try
            {
                returnCode = eUniGetStoIo(this.NetID, axisNo, out inputTemp[0], out outputTemp[0], out activeTemp[0]);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to get STO I/O data from device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axisNo.ToString() + "). " +
                            "error : " + returnCode,
                            "UniDevice.GetStoIo");
                ...
                else
                {
                    ...
                    {
                        input[index] = (inputTemp[index] > 0) ? true : false;
                    }
                    for (int index = 0; index < output.Length; index++)
                    {
                        output[index] = (outputTemp[index] > 0) ? true : false;
                    }
                    for (int index = 0; index < active.Length; index++)
                    {
                        active[index] = (activeTemp[index] > 0) ? true : false;
                    }
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.GetStoIo");
                returnCode = -1;
            }
        ...
        /// <summary>
        /// Set information about each repeating position(max_count: 3) to move axis
        /// </summary>
        /// <param name="axis">			: Axis number</param>
        /// <param name="index">		: Command Index(Id, Address)</param>
        /// <param name="enable">		: Whether repeating mode is enable or disable</param>
        /// # "enable"	: true
        /// # "disable" : false
        /// <param name="absolute">		: Moving mode for repeating to move</param>
        /// # "absolute mode" : true
        /// # "relative mode" : false
        /// <param name="inPosition">	: Check in-position in motion-done or not</param>
        /// # in-position check : true
        /// # none				: false
        /// <param name="profile">		: Motion profile for repeating to move</param>
        /// # trapezoidal	: 0
        /// # s-curve		: 10
        /// <param name="position">		: Target position for repeating to move</param>
        /// <param name="velocity">		: Target velocity for repeating to move</param>
        /// <param name="accel">		: Acceleration time for repeating to move</param>
        /// <param name="decel">		: Deceleration time for repeating to move</param>
        /// <param name="jerkAcc">		: Jerk ratio in acceleration period for repeating to move</param>
        /// <param name="jerkDec">		: Jerk ratio in deceleration period for repeating to move</param>
        /// <param name="delay">		: Delay time after moving axis</param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        /// @ eUniApiReturnCode.Success				: Operation Success
        /// @ eUniApiReturnCode.InvalidAxisNumber	: Invalid axis number
        /// </returns>
        public virtual int SetRepeatPosition(int axis, int index, bool enable, bool absolute, bool inPosition, int profile,
            int position, int velocity, int accel, int decel, int jerkAcc, int jerkDec, int delay)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniSetRepeatPosition(this.NetID, axis, index, enable ? 1 : 0, absolute ? 1 : 0, inPosition ? 1 : 0, profile,
                    position, velocity, accel, decel, jerkAcc, jerkDec, delay);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to set repeat info position to device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axis.ToString() + ")" +
                            "error : " + returnCode,
                            "UniDevice.SetRepeatPosition");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.SetRepeatPosition");
                returnCode = -1;
            }
        ...
        /// <summary>
        /// Get information about each repeating position(max_count: 3) to move axis
        /// </summary>
        /// <param name="axis">			: Axis number</param>
        /// <param name="index">		: Command Index(Id, Address)</param>
        /// <param name="enable">		: Whether repeating mode is enable or disable</param>
        ...
        /// @ eUniApiReturnCode.InvalidAxisNumber	: Invalid axis number
        /// </returns>
        public virtual int GetRepeatPosition(int axis, int index, ref bool enable, ref bool absolute, ref bool inPosition, ref int profile,
            ref int position, ref int velocity, ref int accel, ref int decel, ref int jerkAcc, ref int jerkDec, ref int delay)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniGetRepeatPosition(this.NetID, axis, index, out int tempEnable, out int tempAbs,
                    out int tempInPos, out int tempProf, out int tempPos, out int tempVel, out int tempAcc, out int tempDec,
                    out int tempJerkAcc, out int tempJerkDec, out int tempDelay);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to set repeat position info to device" +
                            "Failed to get repeat info from device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axis.ToString() + ")" +
                            "error : " + returnCode,
                            "UniDevice.GetRepeatPosition");
                }
                else
                {
                    enable = (tempEnable > 0) ? true : false;
                    absolute = (tempAbs > 0) ? true : false;
                    inPosition = (tempInPos > 0) ? true : false;
                    profile = tempProf;
                    position = tempPos;
                    velocity = tempVel;
                    accel = tempAcc;
            ...
            {
                Debug.WriteLine(ex.Message, "UniDevice.GetRepeatPosition");
                returnCode = -1;
            }
        ...
        /// <summary>
        /// Start repeating to move axis
        /// </summary>
        /// <param name="axis"> : Axis number</param>
        /// <param name="count"> : Repeat count</param>
        /// <returns>
        /// @ eUniApiReturnCode.Success			    : Operation Success
        /// @ eUniApiReturnCode.AlreadyOperation	: Already start repeating to move axis
        /// @ eUniApiReturnCode.InvalidAxisNumber	: Invalid axis number
        /// </returns>
        public virtual int StartRepeat(int axis, int count)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniStartRepeat(this.NetID, axis, count);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to start repeating axis to device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axis.ToString() + ")" +
                            "error : " + returnCode,
                            "UniDevice.StartRepeat");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.StartRepeat");
                returnCode = -1;
            }
        ...
        /// @ eUniApiReturnCode.InvalidAxisNumber			: Invalid axis number
        /// </returns>
        public virtual int StopRepeat(int axis)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniStopRepeat(this.NetID, axis);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to stop repeating axis to device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axis.ToString() + ")" +
                            "error : " + returnCode,
                            "UniDevice.StopRepeat");
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.StopRepeat");
                returnCode = -1;
            }
        ...
        /// </summary>
        /// <param name="axis">	     : Axis number</param>
        /// <param name="repeating"> : Whether repeating to move axis is running or not running</param>
        /// # repeating	: 1
        /// # idle		: 0
        /// <param name="index">	 : Repeating index</param>
        /// <returns>
        /// API Return Code(enum eUniReturnCode).
        /// @ eUniApiReturnCode.Success						: Operation Success
        /// @ eUniApiReturnCode.System						: Not initialized API environment
        /// </returns>
        public virtual int GetRepeatStatus(int axis, ref bool repeating, ref int index)
        {
            int returnCode = (int)eUniApiReturnCode.Success;

            try
            {
                returnCode = eUniGetRepeatStatus(this.NetID, axis, out int tempRepeat, out int tempIdx);
                if (returnCode != (int)eUniApiReturnCode.Success)
                {
                    Debug.WriteLine("Failed to get repeating status from device" +
                            "(Network ID: " + this.NetID.ToString() +
                            ", Axis number: " + axis.ToString() + ")" +
                            "error : " + returnCode,
                            "UniDevice.GetRepeatStatus");
                }
                else
                {
                    repeating = (tempRepeat > 0) ? true : false;
                    index = tempIdx;
                }
            }
            catch (Exception ex)
            {
                Debug.WriteLine(ex.Message, "UniDevice.GetRepeatStatus");
                returnCode = -1;
            }
        ...
        #endregion API Wrapper Function
    }
}