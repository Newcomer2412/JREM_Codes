...
{
    /// <summary>
    /// CMessageMiniUI.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class CMessageMiniUI : Window
    {
        ...
        {
            if (m_showOption == 1) m_selectButton = 0;
            else if (m_showOption == 2) m_selectButton = 0;
            else if (m_showOption == 3) m_selectButton = 0;
            Close();
        }
        ...
        {
            if (m_showOption == 1 || m_showOption == 2) m_selectButton = 1;
        ...
        private void Window_MouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            handle.MouseMove += Window_MouseMove;
            handle.CaptureMouse();
        }
        ...
        private void Window_MouseMove(object sender, System.Windows.Input.MouseEventArgs e)
        {
            ...
            {
                handle.MouseMove -= Window_MouseMove; // Detach listener on mouse up.
