...
namespace MachineControlBase
{
    ...
    public class CSystemParameterSingle
    {
        ...
        /// </summary>
        public bool[] bHolderNeedlePinWorkCount = new bool[19]
        {
    ...
    public class CVar
    {
        ...
        /// <summary>
        /// 매뉴얼 파이프 홀더 마그네틱 인젝션 동작
        /// </summary>
        public bool Manual_MagneticInjection = false;
    ...
    public class CVisionData
    {
        ...
        //    { 1883, 2122, 2318, 2124, 1680, 1494, 1677, 2107, 2459, 2673, 2675, 2490, 2111, 1686, 1329, 1126, 1117, 1313, 1670 };
